...
Um projeto para monitoramento e análise de níveis glicêmicos com geração automatizada de relatórios em PDF.

## 📋 Sobre o Projeto

O **Glycemic Map** é uma aplicação desenvolvida para auxiliar no controle e monitoramento da glicemia, oferecendo uma ferramenta completa para:
